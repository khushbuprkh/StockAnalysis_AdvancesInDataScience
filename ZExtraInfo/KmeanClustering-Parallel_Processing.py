...
#             inputClusterone = joblib.load('inputClusterone.pkl')
            ...
            if(i ==1):
                ...
                testdata = dataset1.tail(1)
                joblib.dump(testdata, 'testdata1.pkl')
            ...
            finalreport['MAE']=finalMAE
            finalreport.index = range(1,len(finalreport)+1)
            fh = joblib.load('frameshistory1.pkl') 
            fh.append(finalreport)
            joblib.dump(fh, 'frameshistory1.pkl')
...
#             testdata = dataset1.tail(1)
            testdata = joblib.load('testdata1.pkl')
#             testdata = testDataLatestTrade
#             testexpectedlabel = testdata['closePrice']
...
#     dow = web.DataReader("^DJI", "yahoo", start, end)
    ...
    print(":::::::::::::::::::::::::::::::::::::::::::::::::::::")
    joblib.dump(predictedClosePrice1, 'predictedClosePrice1.pkl')
    joblib.dump(frameshistory1, 'frameshistory1.pkl')
#     joblib.dump(inputClusterone, 'inputClusterone.pkl')
    
    
    p = Pool(20)
#     frameshistory=[]
    p.map(testingModel, range (1,4))
#     testingModel1(inputClusterone)
    print("Testing the Model Finished ...")
    fh1 = joblib.load('frameshistory1.pkl')
